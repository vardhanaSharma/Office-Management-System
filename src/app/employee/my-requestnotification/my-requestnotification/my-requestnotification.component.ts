...
@Component({
  selector: 'app-my-requestnotification',
  templateUrl: './my-requestnotification.component.html',
  styleUrls: ['./my-requestnotification.component.css']
})
export class MyRequestnotificationComponent implements OnInit {
  ...
  constructor(public employeeService: EmployeeService,public requestnotificationService: RequestnotificationService,public taskService: TaskService,private masterService: MasterService, private userService: UserService,public attendenceService: AttendenceService, private router: ActivatedRoute) { 
  }
  ...
  ngOnInit(): void {
    ...
    this.employeeService.getEmployeeByEmail((this.router.snapshot.params.email)).subscribe(
     ...
     this.requestnotificationService.getViewNotificationEmployeeByEmail((this.router.snapshot.params.email)).subscribe(
          (tasklist) => {
    ...
    this.notificationinfo = this.taskcountarray.map(data => data.info); 
